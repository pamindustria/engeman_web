...
@Component({
  selector: 'app-relatorio_cinco_s',
  templateUrl: './relatorio_cinco_s.component.html',
  styleUrls: ['./relatorio_cinco_s.component.css']
})
export class RelatorioCincoSComponent implements OnInit {
